...
public class AuctionPlayersServiceImpl implements AuctionPlayersService {
     ...
     *             if the player is already in the auction.
     * @throws PlayerAlreadyWonException
     *             if the player has already been won.
     */
    @Override
     ...
     *             if the bid is not greater than the previous bid.
     * @throws InsufficientFundsException
     *             if the bidding team cannot afford the bid.
     * @throws RosterFullException
     *             if the bidding team does not have available roster space.
     */
    @Override
     ...
     * 
     * @param leagueId
     *            The league of the auction to get players for.
     ...
     * 
     * @param leagueId
     *            The league to add the player for.
     * @param playerId
     *            The identifier of the player to add.
     * @param teamId
     *            The team with the leading bid on the player.
     * @param bid
     *            The current bid on the player.
     ...
     *            The player to check.
     * @throws AuctionPlayersServiceException
     *             if the player cannot be retrieved.
     * @throws PlayerAlreadyWonException
     *             if the player has been won.
     */
     ...
     * 
     * @param currentExpirationTime
     *            The current expiration time of the auction.
     * @param leagueSettings
     *            The league settings determining the extension time and buffer.
     ...
     * @param leagueId
     *            The league the bid is being made in.
     * @param teamId
     *            The team making the bid.
     * @param bid
     *            The bid to check.
     * @param leagueSettings
     *            The league settings to determine roster size and minimum bids.
     * @throws InsufficientBidException
     *             if the bid is not greater than the previous bid.
     * @throws InsufficientFundsException
     *             if the team cannot afford the bid.
     * @throws RosterFullException
     *             if the team does not have roster space available for the bid.
     * @throws AuctionPlayersServiceException
     ...
     * @param teamId
     *            The team to get the players for.
     ...
     * 
     * @param outstandingPlayers
     *            The players the team is already winning.
     * @param leagueSettings
     *            The settings containing the salary cap and roster size.
     ...
     * @throws AuctionPlayersServiceException
     *             if the player has been won and cannot be updated.
     */
     ...
     * 
     * @param auctionPlayer
     *            The player that has been won.
     * @throws AuctionPlayersServiceException
     *             if the player cannot be updated.
     */
